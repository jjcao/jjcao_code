...
//===========================================================================
#ifndef _GOCOONSPATCHGEN_H
#define _GOCOONSPATCHGEN_H
...
///\{
    ...
    SplineSurface*
    createCoonsPatch(std::vector<boost::shared_ptr<ParamCurve> >& bd_curves,
    ...
    /// \return pointer to the created Gordon Surface.
    SplineSurface*
    createCoonsPatch(std::vector<boost::shared_ptr<SplineCurve> >& bd_curves,
		     std::vector<boost::shared_ptr<SplineCurve> >&
		     cross_curves);
    ...
    SplineSurface*
    createGordonSurface(std::vector<boost::shared_ptr<SplineCurve> >&
			mesh_curves,
    ...
    /// \return pointer to the created Gordon Surface.
    SplineSurface*
    doCreateSurface(std::vector<boost::shared_ptr<SplineCurve> >& mesh_curves,
		    std::vector<double>& params, int& nmb_u_crvs,
    ...
    SplineSurface* loftSurface(std::vector<boost::shared_ptr<SplineCurve> >::iterator
    ...
    /// \return pointer to the created lofting surface.
    SplineSurface*
      loftSurface(std::vector<boost::shared_ptr<SplineCurve> >::iterator first_curve,
		  std::vector<double>::iterator first_param,
		  int nmb_crvs,
    ...
    SplineSurface* tpSurface(const std::vector<boost::shared_ptr<SplineCurve> >& mesh_curves,
			      std::vector<double> params, int nmb_u_crvs,
    ...
    void splitMeshCurves(std::vector<boost::shared_ptr<SplineCurve> >& mesh_curves,
			 std::vector<double>& params, int& nmb_u_crvs,
    ...
    void sortMeshCurves(std::vector<boost::shared_ptr<SplineCurve> >& mesh_curves,
			std::vector<double>& params, int nmb_u_crvs,
			std::vector<int>& cross_index);
    ...
    void getCrossTangs(const std::vector<boost::shared_ptr<SplineCurve> >& curves,
    ...
    void addMissingCrossCurves(const std::vector<boost::shared_ptr<SplineCurve> >& bnd_curves,
    ...
    void getTangBlends(std::vector<boost::shared_ptr<SplineCurve> >& curves, int iedge,
    ...
    void fixCrossEndPts(const std::vector<boost::shared_ptr<SplineCurve> >& bd_curves,
			const std::vector<boost::shared_ptr<SplineCurve> >& cross_curves);
    ...
    void
    makeLoftParams(std::vector<boost::shared_ptr<SplineCurve> >::const_iterator first_curve,
    ...
    void
    reparamBoundaryCurve(std::vector<boost::shared_ptr<SplineCurve> >& curves, double aconst);
