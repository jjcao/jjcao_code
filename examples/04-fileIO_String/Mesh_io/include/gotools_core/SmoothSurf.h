...
//===========================================================================
#ifndef _GOSMOOTHSURF_H_
#define _GOSMOOTHSURF_H_
...
public:
    ...
    void attach(boost::shared_ptr<SplineSurface>& insf, int seem[], int coef_known[],
...
protected:
    int kdim_;            // If the problem has normal-conditions: 3, otherwise: 1
    ...
    boost::shared_ptr<SplineSurface> srf_;        // Pointer to input surface.
