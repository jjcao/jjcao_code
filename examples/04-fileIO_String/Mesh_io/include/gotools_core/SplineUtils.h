...
//===========================================================================
#ifndef _GOSPLINEUTILS_H
#define _GOSPLINEUTILS_H
...
///\{
    ...
    int closest_in_array(const double* pt,
			 const double* array,
			 int n, 
			 int dim);
    ...
    ///              parametrization explained above.
    void closest_on_rectgrid(const double* pt,
			     const double* array,
			     int m, int n,
			     double& clo_u,
			     double& clo_v);
    ...
    void make_coef_array_from_rational_coefs(const double* rationals,
					     double* coefs,
					     int num_coefs,
					     int dim);
    ...
    void osloalg(int ij,int imy,int ik,int in,int *jpl,int *jfi,int *jla,
    ...
    ///              of the B-spline refinement matrix from etau to et.
    void refmatrix(double *et, int im, int ik, 
		   double *etau, int in,
